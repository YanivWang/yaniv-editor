...
| Appearance     | `src/appearance/styles/*.css`                           | Theme tokens and typography (margin, font-size, padding) only |
...
See [Appearance And Color](/guide/appearance) for host-facing usage.
