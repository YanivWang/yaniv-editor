...
```
src/ai.ts
src/appearance/applyAppearance.ts
src/appearance/styles/default.css
src/appearance/styles/notion.css
src/appearance/styles/word.css
src/capabilities/buildExtensions.ts
src/capabilities/registry.ts
src/components/base/ToolbarButton.vue
src/components/base/ToolbarDropdownButton.vue
src/components/editor/code-block/CodeBlockLanguageBadge.vue
src/components/editor/color/ColorPicker.vue
src/components/editor/find-replace/FindReplaceDialog.vue
src/components/editor/find-replace/useFindReplacePanel.ts
src/components/editor/format-painter/FormatPainterButton.vue
src/components/editor/gallery/GalleryButton.vue
src/components/editor/heading/HeadingControl.vue
src/components/editor/image/ImageUpload.vue
src/components/editor/outline/OutlinePanel.vue
src/components/editor/outline/OutlineToggleButton.vue
src/components/editor/outline/index.ts
src/components/editor/outline/scrollToOutlineHeading.ts
src/components/editor/outline/useOutlinePanel.ts
src/components/editor/table/TableButton.vue
src/components/editor/template/TemplateButton.vue
src/components/editor/template/templates.ts
src/components/editor/undo-redo/UndoRedoButton.vue
src/components/editor/word/WordButton.vue
src/components/editor/word/wordExport.ts
src/components/editor/zoom/ZoomBar.vue
src/components/tools/block-menu/BlockPickerMenu.vue
src/components/tools/block-menu/blockMenuActions.ts
src/components/tools/block-menu/blockMenuRegistry.ts
src/components/tools/floating-menu/FloatingMenu.vue
src/components/tools/footer-nav/FooterNav.vue
src/components/tools/footer-nav/footer-nav.css
src/components/tools/header-nav/ToolbarNav.vue
src/components/tools/header-nav/toolbarConfig.ts
src/components/tools/image-toolbar/ImageToolbar.vue
src/components/tools/link-bubble/LinkBubbleMenu.vue
src/components/tools/mention-suggestion/MentionSuggestionMenu.vue
src/components/tools/table-toolbar/TableToolbar.vue
src/components/tools/video-toolbar/VideoToolbar.vue
src/composables/bubbleMenuShouldShow.ts
src/composables/useEditorColorState.ts
src/composables/useFindReplaceHotkey.ts
src/composables/useOverlayFeedback.ts
src/composables/useOverlayMount.ts
src/composables/useRovingTabindex.ts
src/composables/useVirtualFocusPopup.ts
src/core/aiContext.ts
src/core/infra/useEditorLocale.ts
src/core/overlayPortal.ts
src/core/runtime/computeSessionKey.ts
src/core/runtime/resolveChromePolicy.ts
src/core/runtime/useEditorRuntime.ts
src/core/session/contentAdapter.ts
src/core/session/useControlledContent.ts
src/core/session/useEditorSession.ts
src/core/shell/EditorShell.vue
src/core/shell/EditorWorkspace.vue
src/core/shell/useBlockMenuHost.ts
src/extensions/callout/CalloutExtension.ts
src/extensions/dragHandle/DragHandleExtension.ts
src/extensions/embed/EmbedExtension.ts
src/extensions/embed/index.ts
src/extensions/formatPainter.ts
src/extensions/math/MathExtension.ts
src/extensions/math/MathNodeView.vue
src/extensions/math/index.ts
src/extensions/math/types.ts
src/extensions/mention/MentionExtension.ts
src/extensions/office-paste/index.ts
src/extensions/office-paste/officePaste.ts
src/extensions/office-paste/pipeline.ts
src/extensions/office-paste/transform/bookmark.ts
src/extensions/office-paste/transform/excel.ts
src/extensions/office-paste/transform/htmlClasses.ts
src/extensions/office-paste/transform/lineNumber.ts
src/extensions/office-paste/transform/lists.ts
src/extensions/office-paste/transform/style.ts
src/extensions/office-paste/utils.ts
src/extensions/outlineScrollParentBinder.ts
src/extensions/resizableImage.ts
src/extensions/search-replace/index.ts
src/extensions/search-replace/searchReplace.ts
src/extensions/shared/isVisuallyEmpty.ts
src/extensions/shared/nodeViewDecorations.ts
src/extensions/slashCommand/SlashCommandExtension.ts
src/extensions/toggle/ToggleExtension.ts
src/extensions/video.ts
src/extensions/yanivPlaceholder.ts
src/features/ai/AiMenuButton.vue
src/features/ai/adapters/aliyun.ts
src/features/ai/adapters/ollama.ts
src/features/ai/adapters/openai.ts
src/features/ai/client.ts
src/features/ai/components/AiSettingsModal.vue
src/features/ai/config/hostConfig.ts
src/features/ai/config/store.ts
src/features/ai/config/types.ts
src/features/ai/config/useAiConfig.ts
src/features/ai/envConfig.ts
src/features/ai/factory.ts
src/features/ai/index.ts
src/features/ai/prompts.ts
src/features/ai/shared/AiHighlightMark.ts
src/features/ai/shared/AiSuggestionPopover.vue
src/features/ai/shared/CustomAiPopover.vue
src/features/ai/shared/ai-highlight.css
src/features/ai/shared/aiSuggestionManager.ts
src/features/ai/shared/extensionOptions.ts
src/features/ai/translation/TranslationExtension.ts
src/features/ai/translation/index.ts
src/features/ai/translation/languageCodes.ts
src/features/ai/translation/translateStore.ts
src/features/ai/types.ts
src/locales/en-US.ts
src/locales/manager.ts
src/locales/resolveMessage.ts
src/locales/types.ts
src/locales/zh-CN.ts
src/styles/base.css
src/styles/block-hover.css
src/styles/block-picker.css
src/styles/callout.css
src/styles/code-block.css
src/styles/column.css
src/styles/content.css
src/styles/document-layout.css
src/styles/drag-handle.css
src/styles/embed.css
src/styles/floating-menu-toolbar.css
src/styles/heading-dropdown.css
src/styles/image-toolbar.css
src/styles/index.css
src/styles/inline-content.css
src/styles/inline.css
src/styles/mention.css
src/styles/outline.css
src/styles/overlay-portal.css
src/styles/placeholder.css
src/styles/table.css
src/styles/task-list.css
src/styles/toggle.css
src/styles/toolbar-dropdown.css
src/styles/toolbar.css
src/styles/variables.css
src/styles/zoom-toolbar.css
src/utils/editorState.ts
src/utils/linkHrefPolicy.ts
src/utils/mediaSrcPolicy.ts
src/utils/mediaUpload.ts
src/utils/menuItem.ts
src/utils/prosemirrorUtils.ts
