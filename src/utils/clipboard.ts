 ...
 * 复制内容到剪贴板
 */
export async function copyToClipboard(editor: Editor, from: number, to: number): Promise<boolean> {
  try {
 ...
 * 剪切内容到剪贴板
 */
export async function cutToClipboard(editor: Editor, from: number, to: number): Promise<boolean> {
  try {
 ...
 * 从剪贴板粘贴内容
 */
export async function pasteFromClipboard(editor: Editor, position?: number): Promise<boolean> {
  try {
 ...
 * 复制块内容
 */
export async function copyBlock(editor: Editor, from: number, to: number): Promise<boolean> {
 ...
 * 剪切块内容
 */
export async function cutBlock(editor: Editor, from: number, to: number): Promise<boolean> {
 ...
 * 选中节点内容
 */
export function selectNodeContent(editor: Editor, from: number, to: number): boolean {
  try {
...
export async function hasClipboardPermission(): Promise<boolean> {
  try {
    ...
    if ("permissions" in navigator) {
      ...
      return readPermission.state === "granted" && writePermission.state === "granted";
    }
