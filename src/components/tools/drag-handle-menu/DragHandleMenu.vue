    ...
    >
      ...
      <div class="menu-section compact">
        ...
        <div v-if="indentAlignOpen" class="sub-panel">
          ...
          <div class="sub-group">
            <button class="icon-btn" :title="t('editor.indent')" @click="indentList">
              <MenuUnfoldOutlined />
            </button>
            <button class="icon-btn" :title="t('editor.outdent')" @click="outdentList">
              <MenuFoldOutlined />
            </button>
          </div>
        </div>
      ...
      <div class="menu-section compact">
        ...
        <div v-if="colorPanelType" class="color-picker-panel">
          ...
          <div class="sub-actions">
            ...
            <button class="mini-btn" @click="setColorMode('highlight')">
              {{ t("editor.highlight") }}
            </button>
          </div>
        </div>
...
import { COLORS, createMenuConfig, createEditActions } from "./dragHandleMenuConfig";
...
const menuConfig = computed(() => {
  ...
  return createMenuConfig(
    editor.value,
    menuState.value.nodePos,
    menuState.value.nodeTo,
    hideMenu,
    t,
  );
});
