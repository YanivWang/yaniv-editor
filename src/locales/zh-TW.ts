...
export const zhTW: TiptapLocale = {
  ...
  editor: {
    ...
    statusBarShortcutHintsTitle:
      "快速鍵可能因作業系統略有差異：尋找、粗體、斜體、復原/重做等可於工具列提示查看。",
    officePasteImageTitle: "檢測到來自 Office/WPS 且含影像的貼上",
    officePasteImageBody:
      "影像已改為占位，樣式以貼上的 HTML 為準。若需嵌入原始圖片，請使用「插入圖片」或使用較不含圖的內容再貼上。",
